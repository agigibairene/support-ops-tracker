...
The database seeder provisions standard support team accounts (restricted to `@npontu-support.com`):

| Name | Email Address | Password | Role |
| :--- | :--- | :--- | :--- |
| **Irene** | `irene@npontu-support.com` | `irene` | Support Lead |
| **Kwame Owusu** | `kwame.owusu@npontu-support.com` | `password123` | Support Specialist |
| **Ama Mensah** | `ama.mensah@npontu-support.com` | `password123` | Systems Analyst |
...
- **Company Domain Restriction**: [CompanyEmailDomain](file:///home/irene-akawin/Desktop/support-ops-tracker/backend/app/Rules/CompanyEmailDomain.php) rule ensures only verified corporate email addresses (`@npontu-support.com`) can authenticate.
