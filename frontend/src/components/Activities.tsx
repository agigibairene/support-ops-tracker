  ...
  return (
    <div className="p-8">
      <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center gap-2 rounded-xl bg-blue-50 px-3 py-1.5 text-xs font-semibold text-blue-700">
          <Layers size={15} />
      ...
      >
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-5 py-2 text-sm font-semibold text-white shadow-md shadow-blue-600/20 hover:bg-blue-700 disabled:opacity-50"
          >
            <Plus size={16} />
