                ...
                <div className="mt-4 rounded-xl bg-slate-50 p-3 border border-slate-200/60">
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
                    <select
                      ...
                      className="rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-medium text-slate-700 outline-none focus:border-blue-500 sm:w-40"
                    >
                    ...
                    <input
                      ...
                      className="flex-1 rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs text-slate-800 placeholder:text-slate-400 outline-none focus:border-blue-500"
                    />
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 rounded-lg bg-blue-600 px-4 py-2 text-xs font-semibold text-white shadow-sm hover:bg-blue-700 disabled:opacity-50"
                    >
                      <Send size={13} />
